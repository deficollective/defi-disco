...
const CATEGORIES: RankingCategory[] = [
  ...
  },
  {
    ...
    display: (m) => `${m.eoaAdminCount} EOA${m.eoaAdminCount === 1 ? '' : 's'}`,
    isGood: true,
  },
  {
  ...
  },
  {
    ...
    display: (m) => `${m.dependencyCount} dep${m.dependencyCount === 1 ? '' : 's'}`,
    isGood: false,
  },
  {
    title: 'Most Permissioned Functions',
    description: 'Protocols with the most admin-controlled functions',
    sortFn: (a, b) => b.permissionedFunctionCount - a.permissionedFunctionCount,
    display: (m) => `${m.permissionedFunctionCount} fn${m.permissionedFunctionCount === 1 ? '' : 's'}`,
    isGood: false,
  },
  {

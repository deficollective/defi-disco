...
type MetricKey = 'totalCapitalAtRisk' | 'adminCount' | 'dependencyCount' | 'permissionedFunctionCount' | 'capitalPerAdmin'
            ...
            <div key={cat.key}>
              ...
              <ResponsiveContainer width="100%" height={140}>
                ...
                >
                  ...
                  />
                  <Tooltip
                    formatter={(value: number) => [cat.format(value), cat.title]}
                    contentStyle={{
                      backgroundColor: '#fff',

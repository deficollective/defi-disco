      ...
      {governanceAdmins.length === 0 ? (
        <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="bg-white border border-border rounded-lg px-[25px] pt-[25px] pb-[27px] flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono font-bold text-[14px] text-text-primary">Governor Bravo</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[14px] text-text-muted">Vote Execution</span>
                    <span className="font-mono font-bold text-[14px] text-text-primary">Timelock</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[14px] text-text-muted">Voting Unit</span>
                    <span className="font-mono font-bold text-[14px] text-text-primary">ERC-20 Token</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center h-[48px] gap-1">
                    <div className="w-[127px] shrink-0 flex items-center justify-center">
                      <span className="font-bold text-[36px] leading-none text-accent">3 days</span>
                    </div>
                  ...
                  <div className="flex items-center h-[48px] gap-1">
                    <div className="w-[127px] shrink-0 flex items-center justify-center">
                      <span className="font-bold text-[36px] leading-none text-accent">48h</span>
                    </div>
                    <div className="flex-1 flex items-center justify-center">
                      <span className="font-bold text-[14px] uppercase text-text-muted text-center">
                        Execution Delay
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
            <svg className="size-12 text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0 0 12 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75Z" />
            </svg>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-accent/10 px-3 py-1 text-[11px] font-bold text-accent uppercase tracking-[1.2px]">
              Coming Soon
            </span>
          </div>
        </div>

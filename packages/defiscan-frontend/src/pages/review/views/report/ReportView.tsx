...
export function ReportView({ review }: ReportViewProps) {
  ...
  return (
    <article className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              ...
              {review.metadata.tokenName && ` \u00B7 ${review.metadata.tokenName}`}
            </p>
          </div>
      ...
      {/* Action buttons — right-aligned above the nav */}
      <div className="mt-10 flex justify-end gap-2 print:hidden">
        ...
        >
          {copiedAI ? (
            <>
              <svg className="h-4 w-4 text-status-green" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              Copied!
            </>

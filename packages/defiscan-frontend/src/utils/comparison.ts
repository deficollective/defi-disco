...
/** Summary metrics extracted from a compiled review for comparison purposes. */
export interface ProtocolMetrics {
  ...
  dependencyDensity: number // deps per contract
...
/** Radar chart dimensions normalized to 0-100 scale */
...
/** Compute averages for benchmark bars */
...
/** Build shared dependency map for cross-protocol dependency analysis */
